...
class AV2Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        trajs_pos_fut = _trajs['trajs_pos'][:, self.obs_len:self.obs_len+self.pred_len]
        trajs_ang_fut = _trajs['trajs_ang'][:, self.obs_len:self.obs_len+self.pred_len]
        trajs_vel_fut = _trajs['trajs_vel'][:, self.obs_len:self.obs_len+self.pred_len]
        pad_fut = _trajs['has_flags'][:, self.obs_len:self.obs_len+self.pred_len]
        #
